...
import Aapms.Core.Meta (Meta (..), Source (Human), Status (Canon), Timeline (..))
...
-- | @score@ 刻意給 'Just':'Aapms.Api.SchemaSpec' 的樣本要把選配欄位填滿,
...
-- 'Aapms.Api.SchemaSpec' 的鍵集合比對會假性不一致。
...
-- 而測試比對的是__子集__而不是相等(見 'Aapms.Api.SchemaSpec')。
