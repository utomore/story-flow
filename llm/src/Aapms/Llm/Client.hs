...
import Aapms.Llm.Config (LlmConfig (..), chatEndpoint)
...
-- | 一則訊息。
--
-- __住在 @aapms-llm@ 而不是 @aapms-workshop@__:'chat' 的簽名要用它,
...
-- @base_url@ 不合法,全部在 'Aapms.Llm.Config.parseLlmConfig' 那一步就爆掉。
--
...
-- 'Aapms.Llm.Config.parseLlmConfig' 已經擋掉了,這裡是兜底。
