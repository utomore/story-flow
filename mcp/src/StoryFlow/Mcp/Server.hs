...
-- | 進入 stdio 讀取迴圈。@cfgResult@ 是 'StoryFlow.Mcp.Config.resolveConfig' 的
...
initializeResult pv =
  object
    ...
    , "serverInfo" .= object ["name" .= ("story-flow-mcp" :: Text), "version" .= ("0.1.0" :: Text)]
    ]
