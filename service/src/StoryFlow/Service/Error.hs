...
import StoryFlow.Core.Id (Id, Ref, renderId, renderRef)
...
import StoryFlow.Types.Loader (LoadError, renderLoadError)
...
-- | 型別警告的繁中訊息。
--
-- 放在 service 而不是 @core@:'StoryFlow.Core.Registry' 是零 IO 的純模型,
