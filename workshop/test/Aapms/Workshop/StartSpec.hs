-- | T8:'Aapms.Workshop.Stages.startWorkshop'。
module Aapms.Workshop.StartSpec (spec) where
...
import Aapms.Workshop.Fixtures (runS, withCustomVault, withWorkshopVault)
import Aapms.Workshop.Session (Session (..))
import Aapms.Workshop.Stages (startWorkshop)
import Test.Hspec
