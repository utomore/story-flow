-- | T6:'StoryFlow.Workshop.Session' 的快照讀寫(整合測試,真的碰檔案系統)。
module StoryFlow.Workshop.SessionIOSpec (spec) where
...
import StoryFlow.Workshop.Session (Session (..), loadSession, saveSession)
